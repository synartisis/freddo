 ...
 * @param {freddo.Node} root 
 * @param {freddo.Predicate} predicate 
 * @returns {freddo.Node | undefined}
 */
...
/** @type {(type: string, attributes?: freddo.Attribs) => freddo.Node} */
...
/** @type {(content: string) => freddo.Node} */
...
/** @type {(newChild: freddo.Node, refChild: freddo.Node) => void} */
...
/** @type {(parent: freddo.Node, el: freddo.Node) => void} */
...
/** @type {(el: freddo.Node) => freddo.Node} */
...
export function documentBody(/** @type {freddo.Node} */document) {
...
/** @type {(el: freddo.Node, contect: string) => void} */
...
/** @type {(el: freddo.Node, html: string) => void} */
